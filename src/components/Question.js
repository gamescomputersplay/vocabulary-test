  ...
  let questionLetterClassname = "level-letter letter-" + props.level
    ...
    return ( 
      <div className={questionClassname}>
        ...
        <button className="question-button button-yes" onClick = {() => {props.onClick(true, props.word)}}>
          <YesSVG width={iconSize} height={iconSize} fill="#016617" />
          </button>
        <button className="question-button button-no"  onClick = {() => {props.onClick(false, props.word)}}>
