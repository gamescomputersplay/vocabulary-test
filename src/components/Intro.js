    ...
    render() {
        return (
            <div class="introtext">
                ...
                <p>This is how it works: go through a series of flashcards and indicate if you <span class="green">know this word (green tick)</span> or <span class="red">don’t (red cross)</span>.</p>
